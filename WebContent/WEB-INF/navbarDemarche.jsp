		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			...
			<ul class="nav navbar-nav">
	            ...
	            <ul class="dropdown-menu">
	                ...
	                <li><a href="atelier.jsp?go=">Les 7 familles</a></li>
	                <li><a href="atelier.jsp?go=">Le menu equilibré</a></li>
	                <li><a href="atelier.jsp?go=">Alimentation et environement</a></li>
	                <li><a href="atelier.jsp?go=">Le spectacle</a></li>
	            </ul>
	            </li>
