...
<div class="container">
    <div id="content" class="row ">
		<div class="col-xs-6 col-sm-4 col-md-4 col-lg-2"><img class="myImg img-thumbnail" src="images/galerie/Capture-2.png" alt="Trolltunga, Norway"></div>
        <div class="col-xs-6 col-sm-4 col-md-4 col-lg-2"><img class="myImg img-thumbnail" src="images/galerie/Plage deserte.jpg" alt="Trolltunga, Norway"></div>
