...
create table validation(
	...
	modifiedPassword varchar(100) default null,
...
create table role(
	...
	role varchar(100) default 'role2',
	constraint fk_role_utilisateur foreign key(id_utilisateur) references utilisateur(id_utilisateur) on update cascade on delete cascade
);
...
insert into article(id_projet, titre, contenu) values(1, 'Le spectacle', E'Le spectacle avec des enfants.');
...
insert into media(id_article, chemin, nom, type) values(10, 'images/article/10/42.PNG', 'photo enfant - Expression Corporelle', 'photo');
